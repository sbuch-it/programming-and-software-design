...
int main() {
    ...
    BikeComponent a_raggi("raggi ruota anteriore", 30, 100);
    BikeComponent a_cerchione("cerchione ruota anteriore", 50, 200);
    BikeComposite a_ruota("ruota anteriore");
    a_ruota.AddComponent(&a_raggi);
    a_ruota.AddComponent(&a_cerchione);

    // Compongo ruota posteriore
    BikeComponent p_raggi("raggi ruota posteriore", 50, 120);
    BikeComponent p_cerchione("cerchione ruota posteriore", 70, 250);
    BikeComposite p_ruota("ruota posteriore");
    p_ruota.AddComponent(&p_raggi);
    p_ruota.AddComponent(&p_cerchione);

    BikeComponent telaio("telaio", 300, 1000);
    BikeComponent cambio("cambio", 100, 100);
